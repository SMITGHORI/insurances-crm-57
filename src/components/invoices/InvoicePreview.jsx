...
const InvoicePreview = ({
  ...
  const generatePDFBlob = async () => {
    ...
    try {
      ...
      await new Promise(resolve => {
        root.render(React.createElement(ProfessionalInvoiceTemplate, {
          invoice: invoiceData,
          isPDF: true
        }));
  ...
  return <Card className="w-full">
      <CardContent className="p-6">
        ...
        {showPreview && <div className="border border-gray-300 rounded-lg overflow-hidden bg-gray-100">
            ...
            margin: '0 auto'
                ...
                <div ref={invoiceRef} className="w-full h-full">
                  <ProfessionalInvoiceTemplate invoice={invoiceData} isPDF={false} />
                </div>
              </div>
            </div>
        ...
        {!showPreview && <div className="text-center py-12 text-gray-500">
