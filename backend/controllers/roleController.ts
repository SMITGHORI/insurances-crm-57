 ...
 * GET /api/roles
 */
const loadRoles = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 * GET /api/roles/:id
 */
const loadRoleById = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
 ...
 */
const loadRolePermissions = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
 ...
 */
const updateRolePermissions = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
